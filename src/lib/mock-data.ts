...
export const mockHosts: Host[] = [
  {
    ...
    location: { country: 'AU', state: 'VIC', suburb: 'MEL', localArea: 'CARLTON', postcode: '3053' },
  ...
  },
  {
    ...
    location: { country: 'AU', state: 'NSW', suburb: 'SYD', localArea: 'HARRISPARK', postcode: '2150' },
  ...
  },
  {
    ...
    location: { country: 'NZ', state: 'AUK', suburb: 'AKL', localArea: 'PONSONBY', postcode: '1011' },
...
export const mockExperiences: Experience[] = [
  {
    ...
    pricing: { pricePerGuest: 85, maxGuests: 6 }, availability: { days: ['Wednesday', 'Friday', 'Saturday'], timeSlots: ['19:00', '20:00'] },
    location: { country: 'AU', state: 'VIC', suburb: 'MEL', localArea: 'CARLTON' },
  ...
  },
  {
    ...
    pricing: { pricePerGuest: 60, maxGuests: 8 }, availability: { days: ['Tuesday', 'Thursday', 'Saturday'], timeSlots: ['18:00', '19:30'] },
  ...
  },
  {
    ...
    pricing: { pricePerGuest: 120, maxGuests: 4 }, availability: { days: ['Monday', 'Friday'], timeSlots: ['19:00'] },
  ...
  },
  {
    ...
    pricing: { pricePerGuest: 55, maxGuests: 8 }, availability: { days: ['Saturday', 'Sunday'], timeSlots: ['12:00', '19:00'] },
    location: { country: 'AU', state: 'NSW', suburb: 'SYD', localArea: 'HARRISPARK' },
  ...
  },
  {
    ...
    pricing: { pricePerGuest: 65, maxGuests: 6 }, availability: { days: ['Friday', 'Saturday'], timeSlots: ['19:00'] },
  ...
  },
  {
    ...
    pricing: { pricePerGuest: 95, maxGuests: 4 }, availability: { days: ['Thursday', 'Saturday'], timeSlots: ['20:00'] },
    location: { country: 'AU', state: 'NSW', suburb: 'SYD', localArea: 'SURRY' },
  ...
  },
  {
    ...
    pricing: { pricePerGuest: 100, maxGuests: 10 }, availability: { days: ['Saturday'], timeSlots: ['16:00'] },
    location: { country: 'NZ', state: 'AUK', suburb: 'AKL', localArea: 'PONSONBY' },
  ...
  },
  {
    ...
    pricing: { pricePerGuest: 50, maxGuests: 5 }, availability: { days: ['Wednesday', 'Sunday'], timeSlots: ['12:00', '19:00'] },
...
export const mockHostApplications: HostApplication[] = [
    {
        ...
        location: { country: 'AU', state: 'VIC', suburb: 'Melbourne', postcode: '3053' },
    ...
    },
    {
        ...
        location: { country: 'NZ', state: 'AUK', suburb: 'Auckland', postcode: '1011' },
